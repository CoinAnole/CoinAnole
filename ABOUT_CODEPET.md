...
3. **Cost Efficient Multimodal Reasoning Models** - Models like **Kimi K2.5**, **Gemini 3 Flash**, and **Qwen3.5** have the vision skills to analyze images and exercise creative judgement. Avoid **GLM 4.6V**, which can fall into reasoning loops that result in timeouts.
...
- **Kimi K2.5 / Gemini 3 Flash / Qwen3.5** - Vision analysis and prompt generation within the Agent
